...
// --- CLI runner ---
// Guarded so importing sourceFor()/slugify() from a test file never reads
// data/skills.json + data/plugins.json or touches disk as a side effect of
// the import (mirrors the isMain pattern in validate-data.mjs and
// generate-readme.mjs).
